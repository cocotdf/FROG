...
<ul>
  ...
  <li><a href="#probe-attachment-model">7. Probe Attachment Model</a></li>
  <li><a href="#canonical-probe-kinds">8. Canonical Probe Kinds</a></li>
  <li><a href="#probe-lifecycle">9. Probe Lifecycle</a></li>
  <li><a href="#value-capture-semantics">10. Value Capture Semantics</a></li>
  <li><a href="#paused-live-and-retained-views">11. Paused, Live, and Retained Views</a></li>
  <li><a href="#edge-probes">12. Edge Probes</a></li>
  <li><a href="#node-port-probes">13. Node-Port Probes</a></li>
  <li><a href="#local-memory-probes">14. Local-Memory Probes</a></li>
  <li><a href="#ui-related-probes">15. UI-Related Probes</a></li>
  <li><a href="#probe-presentation-model">16. Probe Presentation Model</a></li>
  <li><a href="#probe-management">17. Probe Management</a></li>
  <li><a href="#custom-and-type-specific-probes">18. Custom and Type-Specific Probes</a></li>
...
<ul>
  ...
  <li>the meaning of last-known values,</li>
...
<h3>5.3 Causally committed values</h3>

<p>
Probe-visible values MUST correspond to causally committed source-level execution state.
...
<h2 id="probe-attachment-model">7. Probe Attachment Model</h2>
...
<h2 id="canonical-probe-kinds">8. Canonical Probe Kinds</h2>
...
<h2 id="probe-lifecycle">9. Probe Lifecycle</h2>
...
<h3>9.2 Active and inactive states</h3>

<p>
A probe MAY be in one of the following conceptual states:
</p>
...
<ul>
  ...
  <li><code>unavailable</code> — probe target exists but no value or state snapshot is currently available,</li>
...
<h2 id="value-capture-semantics">10. Value Capture Semantics</h2>
...
<h3>10.2 Last-known value</h3>

<p>
For v0.1, the primary value model of a probe is the <strong>last-known committed value</strong>.
This means the most recent causally committed source-level value observed for the probe target in the current execution context.
</p>

<h3>10.3 Multiple observations</h3>

<p>
If a probe target receives multiple values over time, the base v0.1 model requires that the probe be able to show at least the most recent one.
...
<h2 id="paused-live-and-retained-views">11. Paused, Live, and Retained Views</h2>

<h3>11.1 Live view</h3>

<p>
During a running execution, a probe MAY update continuously as new source-aligned observations become available.
...
<p>
When a debug session is paused, probe values MUST reflect the causally consistent paused snapshot.
...
<p>
A stricter profile MAY support retained probe values after a run has completed or paused.
...
<h3>11.4 No fabricated history</h3>
...
<p>
An edge probe is updated when the probe target receives an observable <code>edge_value_available</code> event in the current execution context.
</p>
...
in the current execution context</code></pre>
...
<h3>12.5 Context-sensitive repeated values</h3>
...
<h2 id="node-port-probes">13. Node-Port Probes</h2>
...
A port probe attached to an input port SHOULD reflect the committed value received at that input in the current execution context.
</p>
...
<p>
If a local-memory probe displays a current stored value during a paused snapshot, that value MUST be the value that is causally committed for the paused live execution instance.
</p>
...
<h2 id="probe-presentation-model">16. Probe Presentation Model</h2>
...
<ul>
  ...
  <li>basic execution context when relevant.</li>
</ul>
...
<h3>16.4 Probe numbering or naming</h3>
...
<h2 id="probe-management">17. Probe Management</h2>
...
<h2 id="custom-and-type-specific-probes">18. Custom and Type-Specific Probes</h2>

<h3>18.1 Rationale</h3>
...
<h3>18.3 Semantic constraints</h3>
...
<ul>
  ...
  <li>it must display causally committed observations only,</li>
...
<h3>18.4 Default probe behavior</h3>
...
<ul>
  ...
  <li>A probe shown during pause MUST reflect the paused causal snapshot.</li>
...
<p>
FROG probes are source-aligned inspection objects for live and retained execution views.
