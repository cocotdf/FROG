...
<h1 align="center">FROG Conformance Case 97</h1>

<p align="center">
  <strong>Explicit UI sequencing correspondence must remain distinct from public-interface-boundary correspondence in canonical execution IR</strong><br/>
...
<ul>
  ...
  <li><a href="#why-ui-sequencing-cannot-be-collapsed-into-public-interface-boundary-correspondence">7. Why UI Sequencing Cannot Be Collapsed into Public-Interface-Boundary Correspondence</a></li>
...
<p>Case: <code>97_explicit_ui_sequencing_correspondence_must_remain_distinct_from_public_interface_boundary_correspondence_in_canonical_execution_ir</code></p>
...
<p><strong>Expected preservation basis:</strong> where canonical execution IR preserves correspondence to explicit UI sequencing participation and also preserves correspondence to public-interface-boundary participation, those correspondences must remain explicitly distinct and recoverable rather than being normalized into one generic program-boundary or execution-order relation.</p>

<hr/>

<h2 id="why">3. Why</h2>
<p>This case protects a critical boundary between two different program-facing structures:</p>
...
<p>Both may participate in externally visible behavior. They do not express the same architectural meaning.</p>
...
<ul>
  ...
  <li><strong>Public-interface-boundary correspondence</strong> answers which public program boundary participation remains part of the canonical execution-facing structure.</li>
</ul>

<p>These categories may coexist in one program and may even interact indirectly. They must not be conflated.</p>
...
<ul>
  ...
  <li>canonical execution IR preserves public-interface-boundary correspondence as public-interface correspondence,</li>
  <li>the reader can distinguish UI-side effect-order participation from public program-boundary participation,</li>
...
<ul>
  ...
  <li>public-interface-boundary correspondence remains recoverable as public-interface correspondence,</li>
  <li>UI sequencing is not reclassified as public-interface participation merely because both may be externally visible,</li>
  <li>public-interface participation is not used as the sole surviving explanation of explicit UI sequencing when sequencing is in scope,</li>
...
<h2 id="why-ui-sequencing-cannot-be-collapsed-into-public-interface-boundary-correspondence">7. Why UI Sequencing Cannot Be Collapsed into Public-Interface-Boundary Correspondence</h2>
<p>UI sequencing cannot be collapsed into public-interface-boundary correspondence because explicit UI-side ordering is not the same architectural relation as public program-boundary participation.</p>

<ul>
  <li>UI sequencing identifies explicit effect-order participation around UI-facing interaction.</li>
  <li>Public-interface-boundary correspondence identifies public program ingress or egress participation.</li>
</ul>

<p>If those categories are blurred together:</p>

<ul>
  <li>UI-side effect ordering can be mistaken for public interface semantics,</li>
  <li>public interface semantics can be mistaken for UI-specific sequencing,</li>
...
<ul>
  ...
  <li>explicit UI sequencing versus explicit state-boundary participation.</li>
</ul>
...
<ul>
  ...
  <li>canonical execution IR preserves explicit UI sequencing relation and public-interface-boundary relation,</li>
