...
<h1 align="center">FROG Conformance Case 113</h1>

<p align="center">
  <strong>Primary source attribution correspondence must remain distinct from control-structure-boundary correspondence in canonical execution IR</strong><br/>
...
<ul>
  ...
  <li><a href="#why-primary-source-attribution-cannot-be-collapsed-into-control-structure-boundary-correspondence">7. Why Primary Source Attribution Cannot Be Collapsed into Control-Structure-Boundary Correspondence</a></li>
...
<p>Case: <code>113_primary_source_attribution_correspondence_must_remain_distinct_from_control_structure_boundary_correspondence_in_canonical_execution_ir</code></p>
...
<p><strong>Expected preservation basis:</strong> where canonical execution IR preserves correspondence to primary source attribution and also preserves correspondence to control-structure-boundary participation, those correspondences must remain explicitly distinct and recoverable rather than being normalized into one generic source-owned boundary relation.</p>

<hr/>

<h2 id="why">3. Why</h2>
<p>This case protects a critical distinction between source-origin explanation and internal structure-owned execution semantics:</p>
...
<p>Both may point back to source-visible material. They do not express the same architectural meaning.</p>
...
<ul>
  ...
  <li>correspondence to control-structure-boundary participation.</li>
</ul>
...
<p>These categories may coexist near the same execution-facing object or the same local derivation slice. They must not be conflated.</p>
...
<ul>
  ...
  <li>ordinary control structures with explicit regions, terminals, or structure-boundary crossings.</li>
</ul>
...
<ul>
  ...
  <li>the reader can distinguish source-origin anchoring from structure-owned execution participation,</li>
...
<ul>
  ...
  <li>source-origin anchoring is not reclassified as structure-boundary participation merely because the attributed object belongs to or appears inside a control structure,</li>
  <li>control-structure-boundary participation is not used as the sole surviving explanation of primary source attribution when such attribution is in scope,</li>
...
<h2 id="why-primary-source-attribution-cannot-be-collapsed-into-control-structure-boundary-correspondence">7. Why Primary Source Attribution Cannot Be Collapsed into Control-Structure-Boundary Correspondence</h2>
<p>Primary source attribution cannot be collapsed into control-structure-boundary correspondence because source-origin explanation is not the same architectural relation as structure-owned execution participation.</p>
...
<ul>
  <li>source-origin explanation can be mistaken for structure-boundary semantics,</li>
  <li>structure-boundary semantics can be mistaken for attribution ownership,</li>
...
<ul>
  ...
  <li>control-structure-boundary correspondence versus public-interface-boundary and ordinary-connectivity correspondence,</li>
...
<ul>
  ...
  <li>canonical execution IR preserves primary source-attribution relation and control-structure-boundary relation,</li>
