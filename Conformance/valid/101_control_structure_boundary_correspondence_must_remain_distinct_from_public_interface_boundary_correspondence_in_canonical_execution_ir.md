...
<h1 align="center">FROG Conformance Case 101</h1>

<p align="center">
  <strong>Control-structure boundary correspondence must remain distinct from public-interface-boundary correspondence in canonical execution IR</strong><br/>
...
<ul>
  ...
  <li><a href="#why-control-structure-boundary-cannot-be-collapsed-into-public-interface-boundary-correspondence">7. Why Control-Structure Boundary Cannot Be Collapsed into Public-Interface-Boundary Correspondence</a></li>
...
<p>Case: <code>101_control_structure_boundary_correspondence_must_remain_distinct_from_public_interface_boundary_correspondence_in_canonical_execution_ir</code></p>
...
<p><strong>Expected preservation basis:</strong> where canonical execution IR preserves correspondence to control-structure boundary participation and also preserves correspondence to public-interface-boundary participation, those correspondences must remain explicitly distinct and recoverable rather than being normalized into one generic ingress, egress, or region-boundary relation.</p>

<hr/>

<h2 id="why">3. Why</h2>
<p>This case protects a critical distinction between internal execution structure and public program boundary structure:</p>
...
<p>Both may involve entry, exit, or boundary participation. They do not express the same architectural meaning.</p>
...
<ul>
  <li><strong>Control-structure-boundary correspondence</strong> answers which ordinary execution-structure boundary participation remains part of canonical execution semantics.</li>
...
<p>These categories may coexist in one program and may be connected through broader execution paths. They must not be conflated.</p>
...
<ul>
  <li>canonical execution IR preserves control-structure-boundary correspondence as control-structure correspondence,</li>
  <li>canonical execution IR preserves public-interface-boundary correspondence as public-boundary correspondence,</li>
  <li>the reader can distinguish internal structure-boundary participation from public program-boundary participation,</li>
...
<ul>
  ...
  <li>internal structure-boundary participation is not reclassified as public-interface participation merely because both may appear as entry or exit-facing boundaries,</li>
  <li>public-interface participation is not used as the sole surviving explanation of control-structure boundary participation when such boundary participation is in scope,</li>
...
<h2 id="why-control-structure-boundary-cannot-be-collapsed-into-public-interface-boundary-correspondence">7. Why Control-Structure Boundary Cannot Be Collapsed into Public-Interface-Boundary Correspondence</h2>
<p>Control-structure boundary cannot be collapsed into public-interface-boundary correspondence because internal structure semantics are not the same architectural relation as public program-boundary participation.</p>
...
<ul>
  ...
  <li>public boundary structure can be mistaken for structure-owned execution semantics,</li>
...
<ul>
  ...
  <li>canonical execution IR preserves control-structure-boundary relation and public-interface-boundary relation,</li>
