...
<h1 align="center">FROG Conformance Case 111</h1>

<p align="center">
  <strong>Primary source attribution correspondence must remain distinct from ordinary dataflow-connectivity correspondence in canonical execution IR</strong><br/>
...
<ul>
  ...
  <li><a href="#why-primary-source-attribution-cannot-be-collapsed-into-ordinary-dataflow-connectivity-correspondence">7. Why Primary Source Attribution Cannot Be Collapsed into Ordinary Dataflow Connectivity Correspondence</a></li>
...
<p>Case: <code>111_primary_source_attribution_correspondence_must_remain_distinct_from_ordinary_dataflow_connectivity_correspondence_in_canonical_execution_ir</code></p>
...
<p><strong>Expected preservation basis:</strong> where canonical execution IR preserves correspondence to primary source attribution and also preserves correspondence to ordinary dataflow connectivity, those correspondences must remain explicitly distinct and recoverable rather than being normalized into one generic source-linked edge or dependency relation.</p>

<hr/>

<h2 id="why">3. Why</h2>
<p>This case protects a critical distinction between source-origin explanation and ordinary internal graph structure:</p>
...
<p>Both may be represented in relation to the same execution-facing object. They do not express the same architectural meaning.</p>
...
<ul>
  ...
  <li>the reader can distinguish source-origin anchoring from ordinary internal graph connectivity,</li>
...
<ul>
  ...
  <li>source-origin anchoring is not reclassified as ordinary connectivity merely because the attributed object participates in graph edges,</li>
  <li>ordinary connectivity is not used as the sole surviving explanation of primary source attribution when such attribution is in scope,</li>
...
<h2 id="why-primary-source-attribution-cannot-be-collapsed-into-ordinary-dataflow-connectivity-correspondence">7. Why Primary Source Attribution Cannot Be Collapsed into Ordinary Dataflow Connectivity Correspondence</h2>
<p>Primary source attribution cannot be collapsed into ordinary dataflow-connectivity correspondence because source-origin explanation is not the same architectural relation as ordinary internal dependency or value transfer.</p>
...
<ul>
  <li>source-origin explanation can be mistaken for graph structure,</li>
  <li>graph structure can be mistaken for attribution ownership,</li>
...
<ul>
  ...
  <li>canonical execution IR preserves primary source-attribution relation and ordinary dataflow-connectivity relation,</li>
