...
<h1 align="center">FROG Conformance Case 98</h1>

<p align="center">
  <strong>Explicit UI sequencing correspondence must not be collapsed into public-interface-boundary correspondence in canonical execution IR</strong><br/>
...
<ul>
  ...
  <li><a href="#why-public-interface-boundary-correspondence-is-not-a-ui-sequencing-substitute">7. Why Public-Interface-Boundary Correspondence Is Not a UI-Sequencing Substitute</a></li>
...
<p>Case: <code>98_explicit_ui_sequencing_correspondence_must_not_be_collapsed_into_public_interface_boundary_correspondence_in_canonical_execution_ir</code></p>
...
<p><strong>Expected rejection basis:</strong> canonical execution IR preserves only public-interface-boundary correspondence where explicit UI sequencing correspondence should also remain explicitly recoverable as a distinct UI-side effect-order relation.</p>
...
<p>That collapse is invalid because explicit UI sequencing is not equivalent to public-interface-boundary participation.</p>
...
<p>A validated program contains both explicit UI sequencing participation and public-interface-boundary participation.</p>
...
<ul>
  ...
  <li>but explicit UI sequencing correspondence is omitted, erased, or folded into public-interface-boundary correspondence,</li>
  <li>or the reader is expected to infer UI-side effect sequencing only from public-boundary participation or implementation-private handling.</li>
</ul>
...
<ul>
  <li>explicit UI sequencing correspondence is omitted while public-interface-boundary correspondence remains,</li>
  <li>explicit UI sequencing correspondence is represented as if it were merely public-interface participation,</li>
  <li>sequencing recovery depends on heuristics about public entry/exit participation, data exposure, or expected UI behavior,</li>
  <li>public-interface-boundary records are used as the sole surviving explanation of explicit UI sequencing when such sequencing is in scope,</li>
  <li>the canonical IR reader cannot distinguish whether a relation is UI-effect-order-facing or public-boundary-facing.</li>
</ul>
...
<h2 id="why-public-interface-boundary-correspondence-is-not-a-ui-sequencing-substitute">7. Why Public-Interface-Boundary Correspondence Is Not a UI-Sequencing Substitute</h2>
<p>Public-interface-boundary correspondence is not a UI-sequencing substitute because:</p>

<ul>
  <li>explicit UI sequencing identifies UI-side effect-order participation,</li>
  <li>public-interface-boundary correspondence identifies public program-boundary participation.</li>
</ul>

<p>Even when both may be externally visible or exposed in tooling, they do not authorize one category to stand in for the other.</p>

<p>If such substitution were allowed:</p>

<ul>
  <li>UI-side sequencing and public interface semantics would become harder to distinguish,</li>
...
<ul>
  ...
  <li>but explicit UI sequencing correspondence has been wrongly collapsed into public-interface-boundary correspondence.</li>
</ul>

<hr/>

<h2 id="rationale">9. Rationale</h2>
<p>This rejection is the natural opposite of the valid UI-sequencing/public-interface-boundary distinction case.</p>
...
<p>That keeps canonical execution IR aligned with the distinction between explicit UI-side effect ordering and public program-boundary participation.</p>
