...
<ul>
  ...
  <li><a href="#what-lowering-means-in-frog">6. What "Lowering" Means in FROG</a></li>
  <li><a href="#lowering-boundary">7. Lowering Boundary</a></li>
  <li><a href="#minimum-preconditions">8. Minimum Preconditions</a></li>
  <li><a href="#lowering-stages">9. Lowering Stages</a>
    <ul>
      <li><a href="#stage-a-ir-conservative-lowering">9.1 Stage A — IR-conservative lowering</a></li>
      <li><a href="#stage-b-backend-oriented-lowering">9.2 Stage B — backend-oriented lowering</a></li>
      <li><a href="#stage-c-runtime-private-realization">9.3 Stage C — runtime-private realization</a></li>
    </ul>
  </li>
  <li><a href="#core-invariants">10. Core Invariants</a></li>
  <li><a href="#required-preservation-obligations">11. Required Preservation Obligations</a></li>
  <li><a href="#allowed-lowering-transformations">12. Allowed Lowering Transformations</a></li>
  <li><a href="#forbidden-lowering-transformations">13. Forbidden Lowering Transformations</a></li>
  <li><a href="#control-structures-and-regions">14. Control Structures and Regions</a></li>
  <li><a href="#state-memory-and-feedback">15. State, Memory, and Feedback</a></li>
  <li><a href="#interfaces-ui-boundaries-and-object-interaction">16. Interfaces, UI Boundaries, and Object Interaction</a></li>
  <li><a href="#data-representation-storage-and-layout">17. Data Representation, Storage, and Layout</a></li>
  <li><a href="#scheduling-placement-and-partitioning">18. Scheduling, Placement, and Partitioning</a></li>
  <li><a href="#attribution-and-mapping-across-lowering">19. Attribution and Mapping Across Lowering</a></li>
  <li><a href="#relation-with-observation-debugging-and-diagnostics">20. Relation with Observation, Debugging, and Diagnostics</a></li>
  <li><a href="#conceptual-lowered-products">21. Conceptual Lowered Products</a></li>
  <li><a href="#minimal-conceptual-shape">22. Minimal Conceptual Shape</a></li>
  <li><a href="#examples">23. Examples</a></li>
  <li><a href="#out-of-scope-for-v01">24. Out of Scope for v0.1</a></li>
</ul>
...
<p>
Lowering begins <strong>after</strong> an open execution-facing IR has been derived from validated FROG program meaning.
Lowering exists to transform that open IR into more target-oriented, backend-oriented, or runtime-oriented derived forms without redefining:
</p>
...
lowering
      |
      v
backend-oriented derived form(s)
      |
      v
compiler / runtime / target-private realization
</code></pre>

<p>
This document does not standardize one universal compiler pipeline. It defines what kind of transformation space belongs to lowering, what lowering MUST preserve, and what lowering MUST NOT silently erase.
</p>
...
<ul>
  ...
  <li>confusing backend contracts with language semantics,</li>
...
<p>
Those topics may be constrained later by backend-family specifications, profile-specific runtime contracts, or a future backend contract document.
</p>

<hr/>

<h2 id="what-lowering-means-in-frog">6. What "Lowering" Means in FROG</h2>
...
<p>
A conforming implementation MAY expose some lowered forms for inspection. However, exposure does not make those forms the normative definition of FROG execution meaning.
</p>

<hr/>

<h2 id="minimum-preconditions">8. Minimum Preconditions</h2>
...
<p>
FROG does not require one fixed number of lowering stages. However, it is useful to distinguish three architectural zones.
</p>

<h3 id="stage-a-ir-conservative-lowering">9.1 Stage A — IR-conservative lowering</h3>
...
<h3 id="stage-b-backend-oriented-lowering">9.2 Stage B — backend-oriented lowering</h3>
...
<p>
At this stage, the representation MAY be less source-shaped. However, semantic faithfulness and required recoverability obligations still apply.
</p>

<h3 id="stage-c-runtime-private-realization">9.3 Stage C — runtime-private realization</h3>
...
<ul>
  ...
  <li>Lowering MUST preserve the distinction between open IR and specialized realization.</li>
</ul>

<hr/>

<h2 id="required-preservation-obligations">11. Required Preservation Obligations</h2>

<p>
The following obligations remain in force through lowering.
</p>

<h3>11.1 Semantic preservation</h3>
...
<h3>11.2 Attribution preservation</h3>
...
<h3>11.3 No semantic laundering</h3>
...
<h2 id="allowed-lowering-transformations">12. Allowed Lowering Transformations</h2>

<p>
The following transformation families are allowed during lowering, provided all applicable invariants remain satisfied.
</p>

<h3>12.1 Structure-to-lower-control transformation</h3>
...
<h3>12.2 Boundary specialization</h3>
...
<h3>12.3 Storage and layout specialization</h3>
...
<h3>12.4 Execution-domain specialization</h3>
...
<h3>12.5 Scheduling preparation</h3>
...
<h2 id="forbidden-lowering-transformations">13. Forbidden Lowering Transformations</h2>
...
<h2 id="control-structures-and-regions">14. Control Structures and Regions</h2>

<p>
The open Execution IR keeps structured control explicit. Lowering is the first stage where a toolchain MAY transform that structured form into lower-level control representation.
</p>
...
<h2 id="state-memory-and-feedback">15. State, Memory, and Feedback</h2>
...
<h2 id="interfaces-ui-boundaries-and-object-interaction">16. Interfaces, UI Boundaries, and Object Interaction</h2>

<p>
Lowering MAY specialize boundary families, but it MUST do so carefully.
</p>

<h3>16.1 Public interface boundaries</h3>
...
<h3>16.2 Front-panel value participation</h3>
...
<h3>16.3 Object-style widget interaction</h3>
...
<h2 id="data-representation-storage-and-layout">17. Data Representation, Storage, and Layout</h2>
...
<h2 id="scheduling-placement-and-partitioning">18. Scheduling, Placement, and Partitioning</h2>
...
<h2 id="attribution-and-mapping-across-lowering">19. Attribution and Mapping Across Lowering</h2>

<p>
Lowering MAY be highly expansive. One source-visible or open-IR object may produce many lowered objects.
</p>
...
<h2 id="relation-with-observation-debugging-and-diagnostics">20. Relation with Observation, Debugging, and Diagnostics</h2>
...
<h2 id="conceptual-lowered-products">21. Conceptual Lowered Products</h2>
...
<h2 id="minimal-conceptual-shape">22. Minimal Conceptual Shape</h2>
...
<h3>23.1 Structured case lowered to branch form</h3>
...
<h3>23.2 Explicit delay lowered to state-cell form</h3>
...
<h3>23.3 Public interface lowered to ABI form</h3>
...
<h3>23.4 Loop lowered with explicit carried state</h3>
...
<h2 id="out-of-scope-for-v01">24. Out of Scope for v0.1</h2>
